...
@section('title')
	...
	<title>Setze dich von deiner Konkurrenz ab</title>
...
<div class="content__wrapper">
	<div class="impressum__contentContainer">
		...
		<div class="row">
			...
			<h4 class="klassenraum__listItems">2. Biete außergewöhnlichen Kundenservice.</h4>
			<p>Kennst du auch diesen Moment, in dem du ein Restaurant verlässt und von dem tollen Kundenservice so sehr begeistert bist, dass du gar nicht gehen willst?</p>
			<p>Ich denke das ist Beweis genug, dass guter Kundenservice einen deutlichen Mehrwert für deine Kunden darstellt. Angenommen, dein Unternehmen verkauft das identische Produkt oder führt die identische Dienstleistung aus wie die Konkurrenz, dann wird der Kundenservice ein Hauptkriterium für deine Kunden sein.</p>
			<p>Das kannst du tun, um den Kundenservice zu verbessern:</p>
			<ul>
				<li class="kurs__listItem">Sei stets bemüht deinen Kunden das beste Erlebnis zu ermöglichen.</li>
				<p>Meiner Meinung nach, sollte das immer dein Ziel sein - egal ob du eine Bäckerei, einen Frisör oder ein Baugeschäft führst.</p>
				<li class="kurs__listItem">Nutze Soziale Medien Plattformen richtig.</li>
				<p>Viele Unternehmen nutzen Soziale Medien Plattformern wie Facebook und Google+, um neue Kunden zu gewinnen. Ich persönlich finde, dass sie stattdessen an erster Stelle für die Pflege von Beziehungen genutzt werden sollten. Sie geben dir die Möglichkeit mit Kunden in Kontakt zu treten und dein Interesse an ihnen zu zeigen.</p>
